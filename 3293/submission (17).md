...
```text
input : รับคำมาห้าบรรทัด
output : พิมคำทั้งห้าออกมาโดยขั้นด้านหน้าและด้านหลังด้วยช่องว่างและ *
```
...
```text
step 1: รับคำมา 5 บรรทัด
step 2: พิมคำทั้งหมดออกมาโดยมี * อยู่หน้าสุดและหลังสุด และ ตามมาด้วยช่องว่าง และ ช่องให้เท่ากับคำที่มีความยาวมากที่สุด
```
