...
```text
input: รับค่ามาสองบรรทัดซึ่งในหนึ่งบรรทัดจะแยกออกมาเป็นตัวแปรได้ สาม ตัว
output: พิมพ์ค่าหลังจากคำนวณหาค่าเฉลี่ยของตัวแปรทั้งหมดจากสองบรรทัดมาจับคู่กัน
```
...
```text
step 1:รับค่ามาสองบรรทัดโดยแต่ละบรรทัดจะแยกค่าออกมาไได้สามตัวแปร
step 2: พิมพ์ผลการคำนวณหาค่าเฉลี่ยของตัวละตัวแปรจับคู่กัน
```
