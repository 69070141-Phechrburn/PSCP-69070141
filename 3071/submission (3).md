...
```text
Input: โปรแกรมรับค่า จำนวน 4 ครั้ง
Output: โปรแกรมพิมพ์ออกมาจากการคำนวณว่าค่า n สามารถหารในช่วง a ถึง b เหลือเศษ n ได้กี่รอบ
```
...
```text
Step 1: รับค่า 4 ครั้ง
Step 2: อ่านค่าและคำนวณ อยู่ในช่วงที่ให้มา หาหารได้เศษที่กำหนดได้ที่ครั้ง
Step 3: พิมพ์จำนวนครั้งที่ค่าที่ได้มาไปหารในช่วงที่ให้มาได้เศษที่กำหนด
```
...
```text
ช่วง 10 ถึง 20 หารด้วย 4 ได้เศษ 3
```
...
```text
ช่วง 20 ถึง 50 หารด้วย 7 เหลือเศษ 2
```
