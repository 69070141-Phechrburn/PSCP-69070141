...
```text
Input: โปรแกรมรับค่า เดือนที่ 1 ถึง 12 และวันที่ตั้งแต่ 1 ถึง 31
Output: โปรแกรมพิมพ์ ฤดู ตามเงื่อนไขที่กำหนดโดย เดือนที่หารสีี่ลงตัว เริ่มต้นหลังจากวันที่ 21
```
...
```text
Step 1: รับค่าเดือนที่ และ วันที่
Step 2 :  ตรวจว่าเดือน และ วัน ที่ให้มา ตรงตามช่วงเงื่อนไขใด
Step 3 :  ถ้าตรงตามช่วงเงื่อนไขของฤดูใด ให้พิมพ์ชื่อฤดูนั้น
```
...
```text
เพราะต้องการดูช่วง เดือนที่ 4 และ วันที่ 1
```
...
```text
จะดูว่าถ้าใส่วันและเดือนเป็น 0 จะได้อะไร
```
