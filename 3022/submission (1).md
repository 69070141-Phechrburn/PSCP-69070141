...
```text
Input: โปรแกรมรับค่านึง และ รับค่า ว่าเป็นหน่วยใด และจะแปลงเป็นอีกหน่วย
Output: โปรแกรม พิมพ์ค่าหลังจากคำนวณหน่วยเสร็จแล้ว
```
...
```text
Step 1: อ่านค่าตัวเลข และหน่วย และอีกหน่วยที่อยากให้แปลงเป็น
Step 2: ตรวจว่าหน่วยวัดอุณหภูมิตรงกับที่กำหนดหรือไม่
Step 3: คำนวณแปลงหน่วยให้เป็น C
Step 4: แปลงหน่วยให้เป็นตามที่ต้องการ
Step 5: พิมพ์ค่าหน่วยวัดอุณหภูมิ
```
...
```text
ดูว่าถ้าหน่วยวัดไม่ตรงกับที่กำหนด
```
