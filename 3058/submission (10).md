...
```text
input: รับค่าความยาวของสะพาน กับ จำนวนอิฐขนาดเล็ก และ อิฐขนาดใหญ่
output: พิมผลคำนวณว่าต้องใช้อิฐขนาดเล็กแค่กี่อันและพอหรือไม่ หลังจากนำอิฐขนาดใหญ๋ไปสร้างแล้ว
```
...
```text
step 1: รับจำนวนอิฐขนาดเล็ก กับอิฐขนาดใหญ่ และความยาวของสะพาน
step 2: คำนวณโดยการนำอิฐขนาดใหญ่มาลบออกจากความยาวของสะพาน และนับความยาวที่เหลือที่ต้องใช้อิฐขนาดเล็ก หรือถ้าอิฐเล็กไม่พอคืนค่า -1
step 3: พิมพ์ผลคำนวณ
```
...
```text
มีอิฐเล็ก 4 อันและ อิฐใหญ่ 1 อัน และความยาวของสะพานคือ 9
```
...
```text
มีอิฐเล็ก 4 อัน และอิฐใหญ่ 1 อัน และความยาวของสะพานคือ 10
```
...
```text
มีอิฐเล็ฏ 0 อัน และ อิฐใหญ่ 10 อัน และความยาวของสะพานคือ 20
```
