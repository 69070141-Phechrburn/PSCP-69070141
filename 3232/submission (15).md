...
```text
input: รับค่ามาเป็นระยะทางที่กบกระโดดได้ และค่าที่สองระยะทางเป้าหมายของกบซึ่งระยะทางที่กบกระโดดได้ลดลง 2 ทุกๆครั้ง
output: พิมผลลัพธ์ที่ได้
```
...
```text
step 1: รับค่าเป็นระยะทางที่กบกระโดดได้ และระยะทางเป้าหมายที่กบจะกระโดดไป
step 2: คำนวณว่ากบจะสามารถกระโดดได้กี่ครั้งซึ่งระยะทางที่กบกระโดดได้ลดลง 2 เมตรทุกๆครั้งที่กระโดด
step 3: พิมผลคำนวณที่ได้
```
