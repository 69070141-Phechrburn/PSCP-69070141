...
```text
Input: โปรแกรมรับค่าสามค่า
Output: พิมพ์ค่าที่คำนวณจากค่าที่ให้มา
```
...
```text
Step 1: รับค่ามาสองบรรทัด
Step 2: ดูเมืองที่ให้มาว่าสอดคล้องกับเงื่อนไขใด
Step 3: พิมพ์ผลคำนวณจากค่าที่ให้มา
```
