...
```text
step 1: รับค่าจำนวนของที่ซื้อและราคาของของชิ้นนั้นๆ
step 2: คำนวณราคารวมกันทั้งหมดและหลังจากลดราคาตามโปรโมชั่นแล้ว
step 3: พิมพ์ผลการคำนวณ
```
