...
```text
Input: โปรแกรมรับผลรวมของสามค่า และ รับค่ามากที่สุดของสามค่า
Output: พิมพ์คำว่า "Surprising" หรือ "Not surprising" ถ้าตรงตามเงื่อนไข
```
...
```text
Step 1:  อ่านค่าของ ผลรวม และ ค่าสูงสุด
Step 2: คำนวณหาค่าต่ำสุดโดย นำค่าสูงสุดคูณสองแล้วลบกับผลรวม
Step 3: ตรวจว่าค่าต่ำสุดที่ได้นั้นน้อยกว่าค่าสูงสุด 2 หน่วยหรือไม่ ถ้าน้อยกว่าพิมพ์ "Surprising" ถ้าไม่พิมพ์ "Not surprising"
```
...
```text
ถ้าผลรวมเป็น 24 และ ค่ามากสุดเป็น 9
```
...
```text
ถ้าใส่ผลรวมเป็น 30 และค่าสูงสุดเป็น 10
```
