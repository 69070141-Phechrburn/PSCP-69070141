...
```text
อินพุตคือ L (ความหนาของแถบ) กับ N (จำนวนช่องที่ปลูก) และเอาต์พุตคือหมายเลขแถบของช่องสุดท้าย ลองวาดตารางเล็ก ๆ ตามตัวอย่าง L=1, N=17 ด้วยมือเพื่อดูว่าแต่ละแถบกินกี่ช่อง
```
...
```text
ผมคิดด้วยการมองว่าช่องในแต่ละแถวจะเพิ่มขึ้นเรื่อยๆทีละหนึ่ง ดังนั้นผมจึงนำตัวแปรนึงขึ้นมาโดยมีค่าเริ่มต้นเท่ากับหนึ่งให้เป็นจำนวนช่องทั้งหมด โดยการบวกด้วยอีกตัวแปรนึงที่เพิ่มขึ้นเรื่อยๆทีละหนึ่ง ซึ่งตัวแปรนี้จะเริ่มที่ศูนย์ ทั้งหมดนั้นผมจะใส่ไว้ใน while loop ที่จำเริ่มนับแถวก่อนจบรอบลูปแต่ละรอบ ซึ่งจะหยุดก็ต่อเมื่อจำนวนของช่องทั้งหมดมากกว่าตำแหน่งช่องที่รับมา แล้วนำชั้นที่ได้มานั้นไปหารด้วยความหนาของแถวที่รับมา โดยการปัดเศษขึ้นทั้งหมด ด้วย math.ceil()
```
