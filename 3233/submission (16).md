...
```text
input: รับค่าเป็นสลาก และตัวที่สองเป็นรหัสสลากที่ได้รางวัลซึ่งรางวัลจะเยอะน้อยตามหลักที่สลากที่ซื้อมาตรงกันกี่ตำแหน่ง
output: พิมเงินรางวัลที่ได้
```
...
```text
step 1: รับค่าเป็นสลาก และตัวที่สองเป็นรหัสสลากที่ได้รางวัล
step 2: ตรวจว่าสลากตรงกับรหัสสลากที่ถูกรางวัลซึ่งรางวัลจะเยอะน้อยตามหลักที่สลากที่ซื้อมาตรงกันกี่ตำแหน่ง
step 3: พิมผลรางวัลที่ได้
```
