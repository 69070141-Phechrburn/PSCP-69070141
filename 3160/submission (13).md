...
```text
input : รับตัวเลขสองตัว
output : พิมพ์ผลคำนวณหาว่าเลขในช่วงของทั้งสองตัวเป็นจำนวนเฉพาะกี่ตัวตัวอะไรบ้าง
```
...
```text
step 1: รับตัวเลขสองตัวให้เป็นช่วง
step 2: คำนวนว่าตัวในช่วงนั้นเป็ฯจำนวนเฉพาะหรือไม่
step 3: พิมผลการคำนวน
```
